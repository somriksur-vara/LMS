...
export class BooksController {
  ...
  @ApiOperation({
    ...
    description: 'Add a new book to the library catalog. Requires LIBRARIAN role.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    summary: 'Update book',
    description: 'Update book information. Requires LIBRARIAN role.',
  })
  @ApiParam({
    name: 'id',
    description: 'Book ID',
  ...
  @ApiOperation({
    summary: 'Delete book',
    description: 'Delete a book from the catalog. Cannot delete books with active issues. Requires LIBRARIAN role.',
  })
  @ApiParam({
    name: 'id',
    description: 'Book ID',
