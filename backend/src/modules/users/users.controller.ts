...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description: 'Create a new user account. Requires LIBRARIAN role.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description: 'Retrieve paginated list of users with optional filters. Requires LIBRARIAN role.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description: 'Retrieve a specific user by ID. Requires LIBRARIAN role.',
  })
  @ApiParam({
    name: 'id',
    description: 'User ID',
  ...
  @ApiOperation({
    summary: 'Update user',
    description: 'Update user information. Requires LIBRARIAN role.',
  })
  @ApiParam({
    name: 'id',
    description: 'User ID',
  ...
  @ApiOperation({
    summary: 'Delete user',
    description: 'Delete a user account. Requires LIBRARIAN role.',
  })
  @ApiParam({
    name: 'id',
    description: 'User ID',
